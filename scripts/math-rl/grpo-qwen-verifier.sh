...
EXP_NOTE=verifier-2k-no-entctl-${VERIFICATION_REWARD_TYPE}
GPU_NUMS=8
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.actor.use_adaptive_entropy_adjustment=False \
    ...
    trainer.save_online_data.train_data_size=5000 \
